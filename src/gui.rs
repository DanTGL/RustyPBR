...
use imgui::{Condition, VerticalSlider, Slider};
...
impl Gui {
    ...
    pub(crate) fn render(
        ...
        imgui::Window::new("Hello world")
            ...
            .build(&ui, || {
                Slider::new("X:", -10.0, 10.0)
                    .build(&ui, &mut self.pos.x);
                
                Slider::new("Y:", -10.0, 10.0)
                    .build(&ui, &mut self.pos.y);
                
                Slider::new("Z:", -10.0, 10.0)
                    .build(&ui, &mut self.pos.z);
            });
